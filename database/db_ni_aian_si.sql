...
(1, 'Aian', 'equipment', 'sdas', 25.00, 157, 'uploads/product_images/684ae0a63a8cb.png', 3, '2025-06-12 14:13:58', '2025-06-14 06:24:36'),
(2, 'Integra 30002', 'feed', 'sda', 123.00, 71, 'uploads/product_images/684ae1b5929ed.png', 3, '2025-06-12 14:18:29', '2025-06-14 06:21:03'),
(3, 'Integra 4000', 'feed', 'sadasd', 123.00, 21, 'uploads/product_images/684ae32d467cf.png', 3, '2025-06-12 14:24:45', '2025-06-13 17:35:44'),
(4, 'sdsad', 'feed', 'dasdass', 121.00, 27, 'uploads/product_images/684bd079cc3ab.png', 3, '2025-06-13 07:17:13', '2025-06-13 17:25:47'),
(5, 'Premium Chicken Feed', 'feed', 'High-quality chicken feed with essential ', 1200.00, 100, NULL, 1, '2025-06-13 15:11:16', '2025-06-14 05:38:05'),
...
(2, 'dsad', 'sdasda', 2.00, 'Percentage', '2025-06-11 14:52:00', '2025-06-15 14:43:00', 1, NULL, 1),
(3, 'abcd', 'sdsadad', 15.00, 'Percentage', '2025-06-12 14:43:00', '2025-06-14 02:44:00', 12, NULL, 0),
(5, 'uwus', 'sdasd', 12.00, 'Percentage', '2025-06-13 06:34:00', '2025-06-14 06:34:00', 2, NULL, 1),
(6, 'qwerty', 'sdasdd', 12.00, 'Percentage', '2025-06-12 06:40:00', '2025-06-14 06:40:00', 2, NULL, 1),
(7, 'althea', 'sada', 1.00, 'Percentage', '2025-06-13 06:45:00', '2025-06-14 06:45:00', 5, NULL, 1),
(8, 'cris', 'hernandez', 50.00, 'Percentage', '2025-06-12 07:05:00', '2025-06-19 07:05:00', 54, NULL, 1);
...
(2, 'admin', '$2y$10$NzR1JAIQAhDrGWLB0m3nNepqqnHDeYxh5cvPM8aEyWs/dX9/j0fiy', 1, '2025-06-12 11:39:25', 'uploads/profile_photos/684abc6d8c9d5.png'),
...
(6, 'aian212', '$2y$10$1G/AEtWLW047EGQlX9fU3eX82IElk9SvLVPwEhzOcQDDeQy2SXRpO', 3, '2025-06-13 14:40:41', NULL),
(7, 'jajaja', '$2y$10$cYmH21ZXBwWmn8drWJCPPevLK/rP9CT1Q6RxyBEiZUTeTHCkCPVRS', 2, '2025-06-13 18:11:21', NULL);
...
--
ALTER TABLE `inventory_history`
  MODIFY `IHID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `loyalty_program`
--
ALTER TABLE `loyalty_program`
  MODIFY `LoyaltyID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `order_promotions`
  MODIFY `OrderPromotionID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `payment_history`
--
ALTER TABLE `payment_history`
  MODIFY `PaytoryID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `promo_usage`
  MODIFY `UsageID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `purchase_orders`
--
ALTER TABLE `purchase_orders`
  MODIFY `Pur_OrderID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `purchase_order_item`
--
ALTER TABLE `purchase_order_item`
  MODIFY `Pur_OrderItemID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `sale_item`
  MODIFY `SaleItemID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
