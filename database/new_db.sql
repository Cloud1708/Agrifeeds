...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 12, 2025 at 06:41 AM
...
(3, 7, 'S', 'D', '2', 'None', 2.00),
(4, 8, 'df', 'rc', 'sdd', 'None', 23.00),
(5, 9, 'aian21312', 'aian', 'test', 'None', 0.00),
(6, 12, 'Ian Isaac', 'Terrenal', '099121', 'Gold', 20.00),
(7, 14, 'Ian Test', 'One', 'aiannn', 'None', 0.00);
...
(3, 10, 'Low Stock', 5, '2025-06-10 10:44:19'),
(4, 10, 'Low Stock', 5, '2025-06-12 04:28:22');
...
(3, 4, 0, 'None', '2025-06-07 02:25:38'),
(4, 6, 20000, 'Gold', '2025-06-08 08:36:57'),
(5, 7, 0, 'None', '2025-06-08 15:02:39');
...
(1, 1, 45.00, 50.00, '2025-06-03 07:06:50', '2024-06-01', '2025-12-20', '2025-06-03 07:06:50'),
(2, 2, 40.00, 45.00, '2025-06-03 07:06:50', '2024-06-01', NULL, '2025-06-03 07:06:50'),
(3, 1, 200.00, 21.00, '2025-06-06 16:00:00', '2025-06-07', NULL, '2025-06-07 07:15:36');
...
(1, 'B-MEG Chicken Feed', 'feed', 'High quality chicken feed', 21.00, 500, NULL, '2025-06-03 07:06:50', '2025-06-07 07:15:36'),
(2, 'Purina Pig Feed', 'supplements', 'Premium pig feed', 45.00, 80, 2, '2025-06-03 07:06:50', '2025-06-03 07:55:14'),
(3, 'Nutri-Mix Cattle Feed', 'feed', 'Balanced cattle feed', 65.00, 20, 1, '2025-06-03 07:06:50', '2025-06-03 07:53:14'),
(4, 'B-MEG Basic Feed', 'feed', 'As', 20.00, 20, NULL, '2025-06-03 07:57:10', '2025-06-03 22:23:18'),
(5, 'Purina Pig Feeds', 'feed', 'AAA', 12.00, 20, NULL, '2025-06-03 08:00:01', '2025-06-03 22:23:27'),
(6, 'B-MEG Chicken Feed', 'supplements', 'AAA', 12.00, 111, NULL, '2025-06-03 08:18:25', '2025-06-03 08:18:25'),
(7, 'Test', 'feed', 'Test Feeds', 500.00, 20, NULL, '2025-06-03 08:24:02', '2025-06-03 08:24:20'),
(8, 'Test2', 'feed', 'Testing', 5000.00, 20, NULL, '2025-06-03 08:25:17', '2025-06-03 08:25:30'),
(9, 'Test', 'supplements', 'Hi', 20.00, 20, NULL, '2025-06-07 07:13:58', '2025-06-07 07:13:58'),
(10, 'll', 'supplements', 'hghgj', 2002.00, 2, NULL, '2025-06-07 07:45:38', '2025-06-07 07:45:38');
...
(2, '2025-06-03 07:06:51', 'Card', 'Jane', 6);
...
(1, 'AgriSupplier Inc.', 'Bulk Supplier', 'Net 30', 'Monthly'),
...
(4, 'aian', '$2y$10$g8GyOKQgRGvKyUxo6Pngh.CM1yNuyI7PeUQ62lxPsyyBPaJhuUZ4e', 3, '2025-06-06 09:06:24', NULL),
(5, 'aian21', '$2y$10$CgtGHZQfbNjPydQauQFHDupk1DJDQMvwiFp4npAaBP8.0dFhqEnai', 3, '2025-06-06 09:19:37', NULL),
(6, 'aian33', '$2y$10$uSPdwZmlWm34vACcS6Fyi.rV3Fj96VsKFfgKvOntlc5XhynB7uaXy', 2, '2025-06-06 10:38:35', NULL),
(7, 'aiann', '$2y$10$Mo7dJcGR9axlqRaCbVrY/ettbtBdsGoSoGlFJGZQaul2BKns7Lr3C', 2, '2025-06-08 07:24:56', NULL),
(8, 'customer4', '$2y$10$hashedpassword', 2, '2025-06-08 10:08:01', NULL),
(9, 'aian21312', '$2y$10$fkNxcc83IWGyh6rALcLIcuVD/7cQ9z.kwwvtmdQreMeOO4fqTdkiq', 2, '2025-06-08 10:12:40', NULL),
(12, 'aian2121', '$2y$10$Tmsp1KFWv1u9w4K9NtUF8u0PJFlkPo.7.WFnQf1KUiU0S4wpm8H0C', 2, '2025-06-08 13:29:40', NULL),
(13, 'aia', '$2y$10$oPsi.3Q3peAet/klWgFXnuxPt3AqLyugVnrO1Zik7ur16imCsH6km', 2, '2025-06-08 14:58:18', NULL),
(14, 'aiannn', '$2y$10$3LMQUqb7OUMSU7kX4Fo6BOdcfrafUOTyVCtAzL4QBZxuTQlAdP5Y.', 2, '2025-06-08 15:02:39', NULL);
...
--
ALTER TABLE `loyalty_program`
  MODIFY `LoyaltyID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `sale_item`
  MODIFY `SaleItemID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
