...
(3, 3, 'CC', 'Henandez', '+639952604071', 'Bronze', 5.00);
...
(3, 3, 5000, 'Bronze', '2025-06-12 11:40:36');
...
(1, 'Integra 2000', 'feed', 'sdas', 120.00, 30, 'uploads/product_images/684ae0a63a8cb.png', 3, '2025-06-12 14:13:58', '2025-06-12 15:08:51'),
(2, 'Integra 3000', 'feed', 'sda', 123.00, 17, 'uploads/product_images/684ae1b5929ed.png', 3, '2025-06-12 14:18:29', '2025-06-12 14:18:29'),
(3, 'Integra 4000', 'feed', 'sadasd', 123.00, 20, 'uploads/product_images/684ae32d467cf.png', 3, '2025-06-12 14:24:45', '2025-06-12 14:24:45'),
(4, 'sdsad', 'feed', 'dasdass', 121.00, 1, 'uploads/product_images/684bd079cc3ab.png', 3, '2025-06-13 07:17:13', '2025-06-13 07:17:13');
...
--
ALTER TABLE `inventory_history`
  MODIFY `IHID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `loyalty_program`
--
ALTER TABLE `loyalty_program`
  MODIFY `LoyaltyID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
