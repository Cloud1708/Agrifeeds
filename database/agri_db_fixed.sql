...
--
-- Host: localhost
-- Generation Time: Jun 11, 2025 at 08:00 PM
...
(1, 0, 'Juan Dela Cruz', 'Farm Owner', 'Active', 5.00),
(2, 0, 'Maria Santos', 'Retailer', 'Active', 3.00),
(3, 7, 'S', '2', 'None', 2.00),
(4, 8, 'df', 'sdd', 'None', 23.00),
(5, 9, 'aian21312', 'test', 'None', 0.00),
(6, 4, 'aian', 'aiannnnn', 'None', 0.00),
(7, 5, 'Ian', 'aian21', 'None', 0.00);
...
--
ALTER TABLE `loyalty_program`
  MODIFY `LoyaltyID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
